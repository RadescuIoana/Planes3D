...
namespace Tema
{
	...
	public:
		...
		void RotateFirstPerson_OX(float angle)
		{
			...
			forward = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 0);
		...
		void RotateFirstPerson_OY(float angle)
		{
			...
			// Use glm::rotate()
			forward = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0);
			right = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0);
			up = glm::cross(right, forward);
		}
		...
		void RotateFirstPerson_OZ(float angle)
		{
			...
			// Don't forget to normalize the vectors
			right = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(forward, 1);
			up = glm::cross(right, forward);
		}
